/**
 * Base Tom Select Module
 *
 * Simplified wrapper for Tom Select with clean architecture.
 * Provides unidirectional data flow: State → View
 * User interactions emit events that orchestrator handles.
 *
