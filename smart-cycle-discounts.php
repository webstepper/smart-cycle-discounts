...
function wsscd_plugin_action_links( $links ) {
	$plugin_links = array(
		'<a href="' . admin_url( 'admin.php?page=smart-cycle-discounts' ) . '">' . esc_html__( 'Dashboard', 'smart-cycle-discounts' ) . '</a>',
		'<a href="' . admin_url( 'admin.php?page=wsscd-campaigns' ) . '">' . esc_html__( 'Campaigns', 'smart-cycle-discounts' ) . '</a>',
	);
