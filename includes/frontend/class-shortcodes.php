...
class SCD_Shortcodes {
    ...
    public function register(): void {
        ...
        add_shortcode('scd_product_discount', [$this, 'product_discount']);
        add_shortcode('scd_product_badge', [$this, 'product_badge']);
        
        // Campaign shortcodes
        add_shortcode('scd_campaign_countdown', [$this, 'campaign_countdown']);
        add_shortcode('scd_campaign_products', [$this, 'campaign_products']);
        
        // General shortcodes
        add_shortcode('scd_active_campaigns', [$this, 'active_campaigns']);
        add_shortcode('scd_discount_timer', [$this, 'discount_timer']);
    }
    ...
    public function active_campaigns($atts): string {
        ...
        $campaigns = $this->campaign_manager->get_active_campaigns(array(
            ...
            <?php foreach ($campaigns as $campaign): ?>
                ...
                <div class="scd-campaign-item">
                    ...
                    <?php if ($atts['show_products'] === 'yes'): ?>
                        <?php echo wp_kses_post( $this->campaign_products( array(
                            'campaign_id' => $campaign->get_id(), 'limit' => 4,
                            'columns' => 4
                        ) ) ); ?>
                    <?php endif; ?>
                </div>
