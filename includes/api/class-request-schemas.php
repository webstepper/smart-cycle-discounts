                ...
                'validate_callback' => function($value, $request) {
                    ...
                    if ($type === 'percentage') {
                        ...
                        if ($value < SCD_Validation_Rules::DISCOUNT_PERCENTAGE_MIN || $value > SCD_Validation_Rules::DISCOUNT_PERCENTAGE_MAX) {
                            return new WP_Error('invalid_percentage', sprintf(
                                __('Percentage must be between %s and %s', 'smart-cycle-discounts'),
                        ...
                        if ($value < SCD_Validation_Rules::DISCOUNT_FIXED_MIN || $value > SCD_Validation_Rules::DISCOUNT_FIXED_MAX) {
                            return new WP_Error('invalid_amount', sprintf(
                                __('Fixed amount must be between %s and %s', 'smart-cycle-discounts'),
