    ...
    public function create( array $data ) {
        ...
        if ( false === $result ) {
            return new WP_Error(
                'db_insert_error',
                sprintf(
                    __( 'Failed to create %s record: %s', 'smart-cycle-discounts' ),
    ...
    public function update( $id, array $data ) {
        ...
        if ( false === $result ) {
            return new WP_Error(
                'db_update_error',
                sprintf(
                    __( 'Failed to update %s record: %s', 'smart-cycle-discounts' ),
                    $this->get_entity_name(),
                    $wpdb->last_error
                )
            );
    ...
    public function delete( $id ) {
        ...
        if ( false === $result ) {
            return new WP_Error(
                'db_delete_error',
                sprintf(
                    __( 'Failed to delete %s record: %s', 'smart-cycle-discounts' ),
                    $this->get_entity_name(),
                    $wpdb->last_error
                )
            );
