 ...
 *
 * Creates all plugin database tables with complete schema.
 * This consolidated migration includes all tables and indexes for optimal performance.
 *
...
class SCD_Migration_001_Initial_Schema {
	...
	private function create_campaigns_table( string $charset_collate ): void {
		...
		$sql = "CREATE TABLE $table_name (
			...
			campaign_status enum('draft','active','paused','completed','expired') DEFAULT 'draft' COMMENT 'DEPRECATED: Use status column instead. Kept for backward compatibility.',
			priority_level tinyint(3) unsigned DEFAULT 5 COMMENT 'DEPRECATED: Use priority column instead',
