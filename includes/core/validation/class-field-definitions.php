...
class WSSCD_Field_Definitions {
	...
	private static function define_discounts_fields() {
		self::$schemas['discounts'] = array(
			...
			'subscription_discount_target' => array(
				'type'        => 'select',
				'label'       => __( 'Subscription Discount Target', 'smart-cycle-discounts' ),
				'required'    => false,
				'default'     => 'recurring',
				'options'     => array(
					'recurring' => __( 'Recurring price only', 'smart-cycle-discounts' ),
					'sign_up'   => __( 'Sign-up fee only', 'smart-cycle-discounts' ),
					'both'      => __( 'Both sign-up fee and recurring', 'smart-cycle-discounts' ),
				),
				'sanitizer'   => 'sanitize_text_field',
				'validator'   => array( __CLASS__, 'validate_in_array' ),
				'pro_feature' => 'subscription_controls',
				'field_name'  => 'subscription_discount_target',
				'tooltip'     => __( 'Choose which subscription price component to discount.', 'smart-cycle-discounts' ),
			),
			'subscription_renewal_limit' => array(
				'type'        => 'number',
				'label'       => __( 'Limit to First X Renewals', 'smart-cycle-discounts' ),
				'required'    => false,
				'min'         => 0,
				'max'         => 999,
				'default'     => 0,
				...
				'validator'   => array( __CLASS__, 'validate_number_range' ),
				'pro_feature' => 'subscription_controls',
				'field_name'  => 'subscription_renewal_limit',
				'tooltip'     => __( 'Limit discount to the first X renewal payments. 0 = unlimited (discount applies as long as campaign is active).', 'smart-cycle-discounts' ),
			),
