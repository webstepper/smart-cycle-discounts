...
class SCD_Metrics_Calculator {
    ...
    public function calculate_campaign_metrics(
        ...
        try {
            ...
            $this->logger->error('Failed to calculate campaign metrics', array(
                'campaign_id' => $campaign_id,
                'date_range' => $date_range,
                'error' => $e->getMessage()
            ));
    ...
    public function calculate_overall_metrics(string $date_range = '7days', bool $use_cache = true): array {
        ...
        try {
            ...
            $this->logger->error('Failed to calculate overall metrics', array(
                'date_range' => $date_range,
                'error' => $e->getMessage()
            ));
    ...
    public function calculate_product_metrics(
        ...
        try {
            ...
            $this->logger->error('Failed to calculate product metrics', array(
                'product_id' => $product_id,
                'date_range' => $date_range,
                'error' => $e->getMessage()
            ));
    ...
    public function calculate_realtime_metrics(?int $campaign_id = null): array {
        try {
            ...
            $this->logger->error('Failed to calculate real-time metrics', array(
                'campaign_id' => $campaign_id,
                'error' => $e->getMessage()
            ));
    ...
    public function calculate_all_campaigns_metrics(string $date_range = '7days', bool $use_cache = true): array {
        ...
        try {
            ...
            $this->logger->error( 'Failed to calculate all campaigns metrics', array(
                'date_range' => $date_range,
                'error' => $e->getMessage()
            ) );
