	...
	public static function map_step_data( string $step, array $step_data ): array {
		...
		switch ( $step ) {
			...
			case 'discounts':
				...
				$numeric_fields = array('discount_value', 'discount_value_percentage', 'discount_value_fixed',
				                       'usage_limit_per_customer', 'total_usage_limit', 'lifetime_usage_cap',
				                       'max_discount_amount', 'minimum_quantity', 'minimum_order_amount',
