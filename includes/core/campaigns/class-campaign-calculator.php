...
class WSSCD_Campaign_Calculator {
	 ...
	 */
	public function calculate_revenue( WSSCD_Campaign $campaign ): float {
	 ...
	 */
	public function calculate_conversion_rate( WSSCD_Campaign $campaign ): float {
		if ( ! $this->analytics_repository ) {
			return 0.0;
		}
	 ...
	 */
	public function calculate_discount_amount( WSSCD_Campaign $campaign, float $base_price, int $quantity = 1 ): float {
	 ...
	 * @return   float                           Discount amount.
	 */
	private function calculate_bogo_discount( WSSCD_Campaign $campaign, float $base_price, int $quantity ): float {
	 ...
	 * @return   float                           Discount amount.
	 */
	private function calculate_tiered_discount( WSSCD_Campaign $campaign, float $base_price, int $quantity ): float {
		$rules = $campaign->get_discount_rules();
	 ...
	 * @return   float                           Discount amount.
	 */
	private function calculate_bulk_discount( WSSCD_Campaign $campaign, float $base_price, int $quantity ): float {
		$rules = $campaign->get_discount_rules();
	 ...
	 */
	public function calculate_performance_score( WSSCD_Campaign $campaign ): float {
	 ...
	 */
	public function calculate_revenue_per_impression( WSSCD_Campaign $campaign ): float {
		if ( ! $this->analytics_repository || ! $campaign->get_id() ) {
			return 0.0;
		}
	 ...
	 */
	public function calculate_engagement_rate( WSSCD_Campaign $campaign ): float {
		if ( ! $this->analytics_repository || ! $campaign->get_id() ) {
			return 0.0;
		}
	 ...
	 */
	public function calculate_estimated_savings( WSSCD_Campaign $campaign, array $cart_items ): float {
		$total_savings = 0.0;
	 ...
	 */
	private function can_apply_to_product( WSSCD_Campaign $campaign, int $product_id ): bool {
	 ...
	 */
	public function calculate_days_remaining( WSSCD_Campaign $campaign ): int {
	 ...
	 */
	public function calculate_roi( WSSCD_Campaign $campaign ): float {
		if ( ! $this->analytics_repository || ! $campaign->get_id() ) {
			return 0.0;
		}
	 ...
	 */
	public function get_metrics_summary( WSSCD_Campaign $campaign ): array {
		return array(
