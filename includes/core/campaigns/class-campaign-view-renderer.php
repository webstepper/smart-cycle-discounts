 ...
 *
 * Handles rendering of campaign views.
 *
...
class SCD_Campaign_View_Renderer {
    ...
    private function render_main_fields(?SCD_Campaign $campaign, array $form_data): void {
        ...
        $this->template_loader->get_template('admin/campaign-edit-products.php', array(
            'campaign' => $campaign,
            'form_data' => $form_data
        ));
        
        $this->template_loader->get_template('admin/campaign-edit-discounts.php', array(
            'campaign' => $campaign,
            'form_data' => $form_data
        ));
        
        $this->template_loader->get_template('admin/campaign-edit-schedule.php', array(
            'campaign' => $campaign,
            'form_data' => $form_data
        ));
    }
