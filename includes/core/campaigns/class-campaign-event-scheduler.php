 ...
 *
 * Handles dynamic scheduling of one-time events for campaign activation/deactivation.
 * Uses ActionScheduler for reliable execution with automatic retry and monitoring.
 *
