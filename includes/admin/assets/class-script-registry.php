...
class SCD_Script_Registry {
    ...
    private function register_vendor_scripts(): void {
        // Tom Select
        $this->add_script('tom-select', array(
    ...
    private function register_core_scripts(): void {
        ...
        $this->add_script('scd-console-logger', array(
        ...
        $this->add_script('scd-i18n-polyfill', array(
        ...
        $this->add_script('scd-init', array(
        ...
        $this->add_script('scd-constants-product-selection', array(
        ...
        $this->add_script('scd-init-shared', array(
        ...
        $this->add_script('scd-shared-utils', array(
        ...
        $this->add_script('scd-debug-logger', array(
        ...
        $this->add_script('scd-theme-color-service', array(
        ...
        $this->add_script('scd-theme-color-init', array(
        ...
        $this->add_script('scd-admin', array(
        ...
        $this->add_script('scd-validation-error', array(
        ...
        $this->add_script('scd-validation-manager', array(
    ...
    private function register_admin_scripts(): void {
        ...
        $this->add_script('scd-main-dashboard', array(
        ...
        $this->add_script('scd-upgrade-banner-dismiss', array(
        ...
        $this->add_script('scd-settings-general', array(
        ...
        $this->add_script('scd-notifications-settings', array(
        ...
        // Queue management
        $this->add_script('scd-queue-management', array(
        ...
        $this->add_script('scd-settings-advanced', array(
        ...
        $this->add_script('scd-settings-performance', array(
        ...
        $this->add_script('scd-campaigns-list', array(
        ...
        $this->add_script('scd-bulk-actions', array(
    ...
    private function register_wizard_scripts(): void {
        ...
        $this->add_script('scd-module-loader', array(
        ...
        // Wizard core modules
        $this->add_script('scd-wizard-event-bus', array(
        ...
        $this->add_script('scd-wizard-state-manager', array(
        ...
        $this->add_script('scd-wizard-orchestrator', array(
            'src' => 'resources/assets/js/wizard/wizard-orchestrator.js',
            'deps' => array_merge($wizard_orchestrator_deps, array(
        ...
        // Core wizard files
        $this->add_script('scd-wizard', array(
        ...
        // Wizard navigation
        $this->add_script('scd-wizard-navigation', array(
        ...
        $this->add_script('scd-wizard-completion-modal', array(
        ...
        $this->add_script('scd-wizard-session-monitor', array(
    ...
    private function register_wizard_shared_modules(): void {
        ...
        $this->add_script( 'scd-shared-ajax-service', array(
    ...
    private function register_analytics_scripts(): void {
        ...
        $this->add_script( 'chart-js', array(
        ...
        $this->add_script('scd-analytics-theme-colors', array(
        ...
        $this->add_script( 'scd-analytics-dashboard', array(
        ...
        $this->add_script('scd-analytics-tracking', array(
    ...
    private function register_component_scripts(): void {
        ...
        $this->add_script('scd-tooltips', array(
    ...
    public function get_scripts_for_page(string $page): array {
        ...
        $filtered_scripts = array_filter( $this->scripts, function( $script ) use ( $page, $action ) {
    ...
    public function get_scripts_by_condition(array $condition): array {
        return array_filter( $this->scripts, function( $script ) use ( $condition ) {
    ...
    private function register_discounts_step_modules(): void {
        ...
        $this->add_script('scd-discounts-config', array(
        ...
        $this->add_script('scd-review-sidebar', array(
    ...
    private function register_discount_type_scripts(): void {
        // Base discount type
        $this->add_script('scd-discount-type-base', array(
        ...
        $this->add_script('scd-discounts-type-registry', array(
    ...
    private function register_schedule_step_modules(): void {
        ...
        $this->add_script('scd-timeline-visualizer', array(
        ...
        $this->add_script('scd-date-time-picker', array(
    ...
    private function register_review_step_modules(): void {
        ...
        $this->add_script('scd-review-health-check', array(
