...
class SCD_Style_Registry {
    ...
    private function register_vendor_styles(): void {
        // Tom Select
        $this->add_style('tom-select', array(
    ...
    private function register_core_styles(): void {
        ...
        $this->add_style('scd-theme-colors', array(
        ...
        $this->add_style('scd-variables', array(
        ...
        $this->add_style('scd-utilities', array(
        ...
        $this->add_style('scd-badges', array(
        ...
        $this->add_style('scd-components', array(
        ...
        $this->add_style('scd-forms', array(
        ...
        $this->add_style('scd-buttons', array(
        ...
        $this->add_style('scd-pro-feature-unavailable', array(
        ...
        $this->add_style('scd-admin', array(
        ...
        $this->add_style('scd-validation-ui', array(
        ...
        $this->add_style('scd-validation', array(
        ...
        $this->add_style('scd-tom-select-custom', array(
    ...
    private function register_admin_styles(): void {
        ...
        $this->add_style('scd-main-dashboard', array(
        ...
        $this->add_style('scd-notifications', array(
        ...
        $this->add_style('scd-notifications-page', array(
        ...
        $this->add_style('scd-wordpress-color-schemes', array(
        ...
        $this->add_style('scd-settings', array(
        ...
        // Tools page styles
        $this->add_style('scd-tools', array(
        ...
        $this->add_style('scd-analytics-upgrade', array(
        ...
        $this->add_style('scd-dashboard-upgrade-banner', array(
        ...
        $this->add_style('scd-recurring-badges', array(
        ...
        $this->add_style('scd-campaigns-list', array(
    ...
    private function register_wizard_styles(): void {
        ...
        $this->add_style('scd-wizard-navigation', array(
        ...
        $this->add_style('scd-wizard-completion-modal', array(
        ...
        $this->add_style('scd-session-expiration-modal', array(
        ...
        $this->add_style('scd-pro-feature-modal', array(
        ...
        $this->add_style('scd-wizard-steps', array(
        ...
        $this->add_style('scd-wizard-fullscreen', array(
    ...
    private function register_wizard_step_styles(): void {
        // Main step styles
        $this->add_style('scd-wizard-step-basic', array(
        ...
        $this->add_style('scd-wizard-step-products', array(
        ...
        $this->add_style('scd-wizard-step-discounts', array(
        ...
        $this->add_style('scd-wizard-step-schedule', array(
        ...
        $this->add_style('scd-wizard-step-review', array(
        ...
        $this->add_style('scd-wizard-step-basic-sidebar', array(
        ...
        $this->add_style('scd-wizard-step-products-sidebar', array(
        ...
        $this->add_style('scd-wizard-step-discounts-sidebar', array(
        ...
        $this->add_style('scd-wizard-step-schedule-sidebar', array(
        ...
        $this->add_style('scd-wizard-step-review-sidebar', array(
    ...
    private function register_analytics_styles(): void {
        ...
        $this->add_style( 'scd-analytics', array(
    ...
    private function register_component_styles(): void {
        ...
        $this->add_style('scd-tooltips', array(
    ...
    public function add_style(string $handle, array $config): void {
        ...
        $this->styles[$handle] = wp_parse_args($config, array(
            'src' => '',
            'deps' => array(),
            'pages' => array(),
            'condition' => array(),
    ...
    public function get_styles_for_page(string $page): array {
        $page_styles = array_filter($this->styles, function($style) use ($page) {
            return in_array($page, $style['pages'], true);
        });

        // Sort by priority
        uasort($page_styles, function($a, $b) {
    ...
    public function get_component_styles(): array {
        return array_filter($this->styles, function($style) {
    ...
    public function get_styles_by_condition(array $conditions): array {
        return array_filter($this->styles, function($style) use ($conditions) {
