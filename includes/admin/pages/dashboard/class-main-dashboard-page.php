...
class SCD_Main_Dashboard_Page {
	...
	private function get_dashboard_data( $date_range ): array {
		...
		$dashboard_data = $this->dashboard_service->get_dashboard_data( array(
			'date_range' => $date_range,
		) );

		// Add campaign suggestions (still generated by page for now)
		$dashboard_data['campaign_suggestions'] = $this->get_campaign_suggestions();
