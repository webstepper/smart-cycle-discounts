...
class SCD_Analytics_Page {
    ...
    public function render(): void {
        ...
        try {
            ...
            $this->logger->error('Failed to render analytics page', array(
                'error' => $e->getMessage(),
    ...
    private function get_overview_metrics(string $date_range): array {
        try {
            ...
            $this->logger->error('Failed to get overview metrics', array(
                'error' => $e->getMessage(),
    ...
    private function get_campaigns_data(string $date_range): array {
        try {
            ...
            $this->logger->error('Failed to get campaigns data', array(
                'error' => $e->getMessage(),
                'date_range' => $date_range
            ));
