<?php
/**
 * Sale Items Filter Handler
 *
 * Handles AJAX requests for analyzing sale items impact.
 *
 ...
 */
class SCD_Sale_Items_Filter_Handler extends SCD_Abstract_Ajax_Handler {
