 ...
 * @subpackage SmartCycleDiscounts/includes/utilities/class-wsscd-log.php
...
class WSSCD_Log {
	 ...
	 * @since    1.0.0
	 * @access   private
	 * @var      WSSCD_Logger|null    $debug_instance    Debug logger instance.
	 */
	private static ?WSSCD_Logger $debug_instance = null;
	 ...
	 * @since    1.0.0
	 * @access   private
	 * @return   WSSCD_Logger    Debug logger instance.
	 */
	private static function get_debug_instance(): WSSCD_Logger {
		if ( null === self::$debug_instance ) {
			self::$debug_instance = new WSSCD_Logger( 'debug' );
		}
